...
public final class ScanFromWebPageManager {
  ...
  public String buildReplyURL(Result rawResult, ResultProcessor resultProcessor) {
    String result = returnUrlTemplate;
    result = replace(CODE_PLACEHOLDER,
                     returnRaw ? rawResult.getText() : resultProcessor.getDisplayContents(), result);
    ...
    result = replace(TYPE_PLACEHOLDER, resultProcessor.getType().toString(), result);
