...
package com.github.barcodeeye.migrated.result;
...
import com.github.barcodeeye.migrated.Contents;
import com.github.barcodeeye.migrated.Intents;
import com.github.barcodeeye.migrated.LocaleManager;
import com.github.barcodeeye.migrated.PreferencesActivity;
...
public abstract class ResultHandler {
  ...
  /**
   * Indicates how many options the derived class wants shown.
   *
  ...
  /**
   * The text of the nth option.
   *
   * @param index From 0 to getOptionCount() - 1
   * @return The button text as a resource ID
   */
  public abstract int getOptionText(int index);
   ...
   */
  public abstract void handleOptionClicked(int index);
   ...
   */
  final void rawLaunchIntent(Intent intent) throws ActivityNotFoundException {
    if (intent != null) {
   ...
   */
  final void launchIntent(Intent intent) throws ActivityNotFoundException {
